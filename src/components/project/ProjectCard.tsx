...
export default function ProjectCard({ project }: ProjectCardProps) {
  ...
  return (
    <Link href={`/project/${project.id}`} className="block group">
      <Card className="flex flex-col gap-4 bg-white border border-gray-100 p-5 shadow-[0_1px_4px_rgba(0,0,0,0.04)] hover:shadow-[0_4px_20px_rgba(0,0,0,0.08)] hover:-translate-y-0.5 transition-all duration-200">
        ...
        <div className="flex items-start justify-between">
          ...
          <Button
            ...
            className="text-gray-300 hover:text-gray-500 h-7 w-7"
          >
            <BsThreeDots size={16} />
          </Button>
        </div>
