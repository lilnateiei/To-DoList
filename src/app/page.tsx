            ...
            {projects.length === 0 ? (
              <EmptyState
                ...
                action={
                  <Link
                    href="/project/new"
                    className="inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-lg text-sm font-medium bg-violet-600 text-white shadow-sm hover:bg-violet-700 h-9 px-4 py-2 transition-colors"
                  >
                    <FaPlus size={11} />
                    สร้างโปรเจกต์แรก
                  </Link>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
                <Link href="/project/new" className="block">
                  <Card className="flex flex-col items-center justify-center gap-2 border-2 border-dashed border-gray-200 rounded-2xl p-8 text-gray-400 hover:border-violet-300 hover:text-violet-500 hover:bg-violet-50/20 transition-all group min-h-[205px] cursor-pointer shadow-none">
